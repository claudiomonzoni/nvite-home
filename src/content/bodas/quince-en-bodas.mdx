...
whatsapp: 8488493900
quinceanera : Maria Elena Olvera
fecha: 2024-12-14
...
import Ventas from "../../components/comunes/Ventas.astro"
  ...
  <section class="grid contenido">
    <div class="conte-cartas">
           <Cartas icono="mdi:clipboard-text-date-outline" titulo="Fecha de nuestra boda" fecha={frontmatter.fecha}/>
      <Cartas icono="mdi:list-status" titulo="Detalles" array={frontmatter.consideraciones}/>
      <Cartas icono="mdi:clothes-hanger" titulo="Código de vestimenta" codigo={frontmatter.vestimenta} />
    </div>
  </section>
  ...
  <section>
   ...
   <Ventas costo="1290" stripe="https://buy.stripe.com/5kA8yN0VK2rxgF27su" version={frontmatter.version} tipo="quince" />