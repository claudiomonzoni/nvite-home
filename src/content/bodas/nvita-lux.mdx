...
<section class="grid pantalla">
  <SliderVentana>
    <div class="img-window">
      ![Boda Nvita](../../assets/bodas/nvitaPlus/gale/galeria1.png){" "}
    </div>
    <div class="img-window">
      ![Boda Nvita](../../assets/bodas/nvitaPlus/gale/galeria2.png)
    </div>
    <div class="img-window">
      ![Boda Nvita](../../assets/bodas/nvitaPlus/gale/galeria3.png){" "}
    </div>
    <div class="img-window">
      ![Boda Nvita](../../assets/bodas/nvitaPlus/gale/galeria4.png){" "}
    </div>
  </SliderVentana>
</section>
