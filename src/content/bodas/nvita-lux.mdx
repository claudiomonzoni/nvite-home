...
<Confirmacion whatsapp={frontmatter.whatsapp} dias_antes={7} version={frontmatter.version} tipoEvento="boda" client:only="react" />




   <Ventas costo="1290" stripe="https://buy.stripe.com/5kA8yN0VK2rxgF27su" version={frontmatter.version} tipo="bodas" />