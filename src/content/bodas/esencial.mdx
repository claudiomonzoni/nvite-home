...
descripcion: Muestra de la invitación de bodas nvita, la invitación básica.
whatsapp: 8488493900
novios: Elena & Marcos
fecha: 2025-12-21
...
import Confirmacion from "../../components/bodas/ConfirmacionBasica.jsx";
...
<section class="grid pantalla flex margen-arriba-abajo">
  ...
  <Detalles
    encabezado="Sugerencia de colores"
    colores={frontmatter.coloresVestimenta}
  />
</section>
