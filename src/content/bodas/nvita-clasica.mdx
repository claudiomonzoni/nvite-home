---
version: clasica
titulo: Nvita Clasica muestra
slug: nvita-bodas-clasica
...
<ProgresoInvitados  porcentajeInvitadosActual={33}  porcentajeMostrarInvuitados={80} Frase={"¡Ya se armó la fiesta! 🎊 Casi todos han confirmado, ¡solo faltas tú!"}mostrarSiempre={false} /> 
</section>
<section class="grid contenido">
  <Padres
...
<section class="grid pantalla">
  <Galeria>
    ![Boda Nvita](../../assets/bodas/nvitaPlus/gale/boda.webp) ![Boda
    Nvita](../../assets/bodas/nvitaPlus/gale/boda1.webp) ![Boda
    Nvita](../../assets/bodas/nvitaPlus/gale/boda3.webp) ![Boda
    Nvita](../../assets/bodas/nvitaPlus/gale/boda4.webp) ![Boda
    Nvita](../../assets/bodas/nvitaPlus/gale/boda5.webp)
  </Galeria>
</section>
...
<ProgresoInvitados> </ProgresoInvitados>
<Ventas
  costo="990"
