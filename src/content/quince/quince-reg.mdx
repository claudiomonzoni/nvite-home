...
json: quincePlus
whatsapp: 8488493900
novios : Maria Elena Olvera Martínez
fecha: 2024-12-14
...
import Ventas from "../../components/comunes/Ventas.astro"
  ...
  <section class="grid contenido">
    <div class="conte-cartas">
      <Cartas icono="mdi:clipboard-text-date-outline" titulo="Fecha de mis XV años" fecha={frontmatter.fecha}/>
  ...
  <section>
   ...
   <Ventas costo="990" stripe="https://buy.stripe.com/7sIbKZfQE5DJ1K8eUX" version={frontmatter.version} tipo="quince" />