import { a as createComponent, r as renderTemplate, f as renderComponent, m as maybeRenderHead } from '../../chunks/astro/server_CKmjmX1y.mjs';
import 'kleur/colors';
...
<input type="password" name="password" id="password" autocomplete="password" placeholder="Agrega una contraseñá segura" data-astro-cid-mwaobxyy> </label> <button data-astro-cid-mwaobxyy>Ingresa</button> </form> <p data-astro-cid-mwaobxyy>Aún no tienes cuenta? <a href="/panel/registro" data-astro-cid-mwaobxyy>Registrate</a></p> </div> </div> <div class="der" data-astro-cid-mwaobxyy> <img src="/panel-ingreso.webp" alt="ingresar a panel nvita" data-astro-cid-mwaobxyy> </div> </div> ` })} `;
}, "C:/Users/claud/OneDrive/Escritorio/Nvitaciones/nvitaciones.com/src/pages/panel/ingresar.astro", void 0);

const $$file = "C:/Users/claud/OneDrive/Escritorio/Nvitaciones/nvitaciones.com/src/pages/panel/ingresar.astro";
